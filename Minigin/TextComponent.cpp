...
int boop::TextComponent::GetHeight() const
{
	int height;
	SDL_QueryTexture(m_pTextTexture->GetSDLTexture(), nullptr, nullptr, nullptr, &height);
	return height;
}
int boop::TextComponent::GetWidth() const
{
	int width;
	SDL_QueryTexture(m_pTextTexture->GetSDLTexture(), nullptr, nullptr, &width, nullptr);
	return width;
}

void boop::TextComponent::UpdateTexture()
{
